                ...
                <section className="grid gap-x-36 gap-y-12 md:grid-cols-2 items-center justify-between">
                    <article>
                        ...
                        <p className="font-sans text-xl mt-4 text-gray-500">
                            ...
                            pickled banjo bespoke mlkshk intelligentsia edison
                            bulb synth.
                        </p>
                        <p className="font-sans text-xl mt-4 text-gray-500">
                            Cardigan prism bicycle rights put a bird on it deep
                            v.
                        </p>
                        <p className="font-sans text-xl mt-4 text-gray-500">
                            Hashtag swag health goth air plant, raclette
                            listicle fingerstache cold-pressed fanny pack
                            bicycle rights cardigan poke.
                        </p>
                    </article>
                    <article>
                        <form
